...
__all__ = ['main_app', 'update', 'Drao26mName', 'COLLECTION', 'APPLICATION']


APPLICATION = 'drao26m2caom2'
COLLECTION = 'DRAO'


class Drao26mName(ec.StorageName):
    """Naming rules:
    - support mixed-case file name storage, and mixed-case obs id values
    - support uncompressed files in storage
    """

    DRAO26M_NAME_PATTERN = '*'

    def __init__(self, obs_id=None, fname_on_disk=None, file_name=None):
        self.fname_in_ad = file_name
        super(Drao26mName, self).__init__(
            obs_id, COLLECTION, Drao26mName.DRAO26M_NAME_PATTERN, 
            fname_on_disk)
